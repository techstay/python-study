...
for row in range(2, 2+N):
    ...
    ws[f'b{row}'] = get_random_mark()
    ws[f'c{row}'] = get_random_mark()
    ws[f'd{row}'] = get_random_mark()
    ws[f'e{row}'] = get_random_mark()
    ws[f'f{row}'] = get_random_mark()
    ws[f'g{row}'] = get_random_mark()
